...
% *the backbone optimizer: surrogate-assisted evolutionary algorithm*
%
% ------------
% Reference:
% ------------
...
specifications = [1 1 1 50 k; % STOP 1
    ...
    5 1 8 50 k; % STOP 11
    2 2 7 50 k]; % STOP 12
backbone_opt = 'saea'; % ea, saea
FEsMax = 200; % the maximum function evaluations
no_problems = size(specifications,1);

%% Generation of the STOPs
folder_problems = '.\benchmarks-saea'; % the folder used for storing the generated STOPs
